...
export default function SubModulPenggeledahanPage() {
  const processList = [
    "Penggeledahan",
    "Tindakan Terus",
    "Ketua Unit",
  ...
  const records = [
    {
      refNo: "PGD-2026-001",
      pegawai: "Pegawai Penggeledahan 1",
      perkara: "Penggeledahan Premis A",
      status: "Dalam Tindakan",
      updatedAt: "11 Feb 2026",
    },
    {
      refNo: "PGD-2026-002",
      pegawai: "Pegawai Penggeledahan 2",
      perkara: "Penggeledahan Premis B",
      status: "Semakan Ketua Unit",
      updatedAt: "10 Feb 2026",
    },
    {
      refNo: "PGD-2026-003",
      pegawai: "Pegawai Penggeledahan 3",
      perkara: "Penggeledahan Premis C",
