...
import {
  ...
  licenseHolderSubmodules,
  type LicenseHolderSubmoduleSlug,
} from "../_lib/license-holder";

export default function LicenseHolderIndexPage() {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Quick Process Launcher - Pemegang Lesen</CardTitle>
      </CardHeader>
      <CardContent className="space-y-3">
        {licenseHolderSubmodules.map((submodule) => {
          const quickLinks = getLicenseHolderQuickProcessLinks(
            submodule.slug as LicenseHolderSubmoduleSlug,
          );
