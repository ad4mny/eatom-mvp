...
type RadiationWorkerInformationSubmodulePageProps = {
...
export default async function RadiationWorkerInformationSubmodulePage({
  params,
}: Readonly<RadiationWorkerInformationSubmodulePageProps>) {
