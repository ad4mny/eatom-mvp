...
type RadiationWorkerInformationProcessPageProps = {
...
export default async function RadiationWorkerInformationProcessPage({
  params,
}: Readonly<RadiationWorkerInformationProcessPageProps>) {
